    ...
    <div className="absolute top-full right-0 mt-2 w-56 bg-white border border-[#E8EDF5] rounded-xl shadow-[0_20px_40px_-12px_rgba(15,23,42,0.15)] overflow-hidden z-50">
      ...
      <div className="py-1">
        ...
        <Link
          ...
          className="flex items-center gap-3 px-4 py-2.5 text-[13px] font-medium text-[#4B5563] hover:bg-[#F9FAFB] hover:text-[#111827] transition-colors"
        >
          <svg viewBox="0 0 24 24" className="w-4 h-4 text-[#6B7280]" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <circle cx="12" cy="12" r="10" />
        ...
        <Link
          href="/privacy"
          onClick={() => setSettingsOpen(false)}
          className="flex items-center gap-3 px-4 py-2 text-[12px] font-medium text-[#6B7280] hover:bg-[#F9FAFB] hover:text-[#111827] transition-colors"
        >
          Privacy Policy
        </Link>
        ...
        <div className="flex-1 flex flex-col overflow-hidden min-w-0">
          ...
          <div className="flex-1 flex overflow-hidden gap-4">
            <main className="flex-1 flex flex-col overflow-hidden min-w-0">
              ...
              {/* BOTTOM BAR - Now inside main content area (aligned with upload) */}
              {bottomBar && (
            ...
            {rightPanel && (
              <aside className="w-[320px] flex-shrink-0 flex flex-col gap-4 overflow-hidden">
                ...
                {/* Create PDF Button - Aligned with bottom bar */}
                {actionButton && (
