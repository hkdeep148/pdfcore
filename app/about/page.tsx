    ...
    <div className="min-h-screen bg-white font-['Inter',sans-serif]">
      ...
      <section className="relative overflow-hidden pt-12 md:pt-20 pb-16 md:pb-24">
        ...
        <div className="relative max-w-[1200px] mx-auto px-5 md:px-8 text-center">
          ...
          >
            {/* Badge */}
            <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[#EAF1FF] border border-transparent text-[#1E63FF] text-[11px] md:text-[12px] font-bold uppercase tracking-wider mb-5">
              <Heart size={13} />
              <span>Our Story</span>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
            ...
            >
              <div className="relative aspect-square max-w-md mx-auto">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-[#EFF3FF] via-[#F3E8FF] to-[#FCE7F3] rounded-[40%] blur-2xl opacity-70" />

                {/* Main card */}
                <div className="relative bg-white rounded-3xl p-8 shadow-[0_20px_60px_-15px_rgba(15,23,42,0.15)] border border-[#ECEDF3]">
                  <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#1E63FF] to-[#6D35FF] flex items-center justify-center mb-6 shadow-[0_10px_30px_-8px_rgba(109,53,255,0.5)]">
                    <FileText className="w-10 h-10 text-white" strokeWidth={1.8} />
                  </div>

                  <h3 className="text-[22px] font-extrabold text-[#07122E] mb-3">
                    Free Forever
                  </h3>
                  <p className="text-[14px] text-[#4B5874] leading-relaxed mb-5">
                  ...
                  <div className="space-y-2.5">
                    {[
                      ...
                      <div key={item} className="flex items-center gap-2.5">
                        ...
                        <span className="text-[13.5px] text-[#26324B] font-medium">
                          {item}
                        </span>
                      </div>
                    ))}
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#EAF1FF] text-[#1E63FF] text-[11px] font-bold uppercase tracking-wider mb-4">
                <Sparkles size={12} />
                <span>Our Mission</span>
              </div>

              <h2 className="font-['Space_Grotesk',sans-serif] text-[28px] md:text-[38px] font-extrabold text-[#07122E] tracking-tight leading-tight mb-5">
                Powerful PDF Tools,{' '}
                <span className="text-[#1E63FF]">Zero Cost</span>
              </h2>

              <p className="text-[15px] md:text-[16px] text-[#4B5874] leading-relaxed mb-4">
              ...
              <p className="text-[15px] md:text-[16px] text-[#4B5874] leading-relaxed mb-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-xl bg-[#F8FAFF] border border-[#E7ECF5]">
                  <div className="w-10 h-10 rounded-lg bg-[#EAF1FF] flex items-center justify-center mb-3">
                    <Zap className="w-5 h-5 text-[#1E63FF]" />
                  </div>
                  <h4 className="text-[14px] font-extrabold text-[#07122E] mb-1">
                    Lightning Fast
                  </h4>
                  <p className="text-[12.5px] text-[#4B5874] leading-relaxed">
                    Files processed instantly in your browser
                  </p>
                </div>
      ...
      <section className="py-16 md:py-24 bg-[#F8FAFC]">
        <div className="max-w-[1200px] mx-auto px-5 md:px-8">
          <div className="text-center mb-12 md:mb-16">
            ...
            <h2 className="font-['Space_Grotesk',sans-serif] text-[28px] md:text-[38px] font-extrabold text-[#07122E] tracking-tight">
              Our Core Values
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-5 md:gap-6">
            <ValueCard
              icon={<Lock size={28} />}
              title="Privacy First"
              description="Your files are processed entirely in your browser. We never upload, store, or access your documents on our servers."
              color="#7C3AED"
              bgColor="#EDE9FE"
            />
            <ValueCard
              icon={<Heart size={28} />}
              title="Always Free"
              description="No premium tiers, no hidden costs, no watermarks. Every tool is completely free for everyone, forever."
              color="#EF4444"
              bgColor="#FEE2E2"
            />
            <ValueCard
              ...
              description="Clean, intuitive tools that just work. No learning curve, no complicated settings — just fast results."
              color="#F59E0B"
              bgColor="#FEF3C7"
            />
            <ValueCard
              ...
              description="Works on any device — mobile, tablet, or desktop. No downloads, no installations, no signup required."
              color="#0EA5E9"
              bgColor="#E0F2FE"
            />
            <ValueCard
              ...
              description="We&apos;re upfront about how our tools work. No dark patterns, no data collection, no misleading claims."
              color="#16A34A"
              bgColor="#DCFCE7"
            />
            <ValueCard
              ...
              description="We&apos;re always adding new tools and improving existing ones based on what our users actually need."
              color="#EC4899"
              bgColor="#FCE7F3"
            />
          </div>
        ...
        <div className="max-w-[1200px] mx-auto px-5 md:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            <StepCard
              step="01"
              title="Choose a Tool"
              description="Pick from 10+ PDF tools — merge, split, compress, convert, rotate, and more."
            />
            <StepCard
              step="02"
              title="Upload Your File"
              description="Drag & drop your PDF or images. Everything happens in your browser — no upload to servers."
            />
            <StepCard
              step="03"
              title="Download Result"
              description="Get your processed file instantly. No watermarks, no limits, no signup required."
            />
          </div>
        </div>
      </section>
      ...
      {/* ============ WHY US SECTION ============ */}
      <section className="py-16 md:py-24 bg-gradient-to-br from-[#F5F3FF] via-white to-[#EFF6FF]">
        <div className="max-w-[1000px] mx-auto px-5 md:px-8">
          <div className="text-center mb-10 md:mb-14">
            <h2 className="font-['Space_Grotesk',sans-serif] text-[28px] md:text-[38px] font-extrabold text-[#07122E] tracking-tight">
              Why Choose <span className="text-[#1E63FF]">PDF Core</span>?
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-5">
            {[
              ...
              <motion.div
                ...
                className="flex items-start gap-4 p-5 bg-white rounded-xl border border-[#ECEDF3] hover:border-[#C9D8F3] hover:shadow-[0_8px_20px_-6px_rgba(15,23,42,0.08)] transition-all"
              >
                <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#EFF3FF] to-[#DBEAFE] flex items-center justify-center flex-shrink-0">
                  <CheckCircle2 className="w-5 h-5 text-[#1E63FF]" />
                </div>
                <div>
                  <h4 className="text-[15px] font-extrabold text-[#07122E] mb-1">
                    {item.title}
                  </h4>
...
function StatCard({ icon, value, label, color, bgColor }: StatCardProps) {
  return (
    <div className="bg-white rounded-2xl p-5 md:p-6 border border-[#ECEDF3] text-center hover:shadow-[0_8px_20px_-6px_rgba(15,23,42,0.08)] transition-all">
      <div
      ...
      <div className="text-[22px] md:text-[28px] font-extrabold text-[#07122E] mb-1">
        {value}
      </div>
      <div className="text-[12px] md:text-[13px] font-semibold text-[#4B5874]">
        {label}
      </div>
    </div>
  );
...
function ValueCard({ icon, title, description, color, bgColor }: ValueCardProps) {
  return (
    <motion.div
      ...
      className="bg-white rounded-2xl p-6 md:p-7 border border-[#ECEDF3] hover:border-[#C9D8F3] hover:shadow-[0_12px_28px_-8px_rgba(15,23,42,0.12)] transition-all"
    >
      <div
      ...
      <p className="text-[14px] text-[#4B5874] leading-relaxed">{description}</p>
    </motion.div>
  );
}
...
function StepCard({ step, title, description }: StepCardProps) {
  return (
    <div className="relative bg-white rounded-2xl p-7 border border-[#ECEDF3] hover:shadow-[0_12px_28px_-8px_rgba(15,23,42,0.1)] transition-all">
      <div className="text-[48px] font-extrabold bg-gradient-to-r from-[#1E63FF] to-[#6D35FF] bg-clip-text text-transparent mb-3 leading-none">
        {step}
      </div>
